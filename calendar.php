 ...
 */
$order_per_day_statement = "SELECT DATE_FORMAT(date, '%e') AS day_of_month, COUNT(*) AS total_orders FROM purchases WHERE DATE_FORMAT(date, '%m')=$month AND DATE_FORMAT(date, '%d')=$current_day GROUP BY day_of_month";
