...
<body>
                  ...
                  <div class="custom_menu">
                     ...
                     <?php else : ?>
                        <ul>
                           ...
                           <?php } ?>
                           <li><a href="#" id="chat_btn">Chat</a></li>
   ...
   <!-- Body/Products List generated by PHP -->
   ...
   <dialog id="chat_modal" style="border: 0; border-radius: 30px; padding: 70px; box-shadow: 5px 5px 20px rgba(0, 0, 0, 0.4);">
      <div class="messages" style="width: 700px; height: 500px; overflow-y: scroll;"></div>
      <div class="message_box" style="display: flex; justify-content: center; align-items: center; gap: 30px; padding-top: 20px;">
         ...
         <button id="send_btn" style="background-color: goldenrod; padding: 7px 40px; border-radius: 30px;">Send</button>
      </div>
   </dialog>
   ...
   <script>
      ...
      // Show dialog element as a modal when chat_btn is clicked
      chat_btn.addEventListener("click", () => {
         chat_modal.showModal();
      })

      // Garbage from template ew
      function openNav() {
