...
<body>
    <div style="background-color: goldenrod; border-radius: 50%; width: min-content; height: min-content; padding: 5px 15px; position: fixed; box-shadow: 3px 3px 10px #262626; bottom: 20px; right: 20px;">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" style="width: 50px; height: 50px; color: whitesmoke;">
